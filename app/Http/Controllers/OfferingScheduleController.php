...
class OfferingScheduleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //phaseLog
        $this->logPhase($request->id_jobapply, 'OFFERING', $request->offering_notes, 'Set schedule offering by admin recruiter', '1');
    ...
    public function updateResult(Request $request, $id)
    {
        ...
        try {
            ...
            if($request->approval_action == '2'){
                ...
                //phaseLog
                $this->logPhase($id_jobapply, $progressStatus . ' AFTER OFFERING SESSION', $request->result_notes, 'Reject after review result offering by admin recruiter', '1');
