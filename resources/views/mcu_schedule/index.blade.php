...
<div class="page-content">
    <div class="card">
        <div class="card-header">
            <h4 class="text-bold">Step 4 - MCU Schedules</h4>
        </div>
        <div class="card-body">
            @if(session('success'))
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="viewDetailModalLabel{{ $schedule->id }}">MCU Detail</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="mb-2">
                                                    <strong>MCU Date:</strong><br>
                                                    {{ $schedule->mcu_date }}
                                                </div>
                                                <div class="mb-2">
                                                    <strong>Address:</strong><br>
                                                    {{ $schedule->mcu_address }}
                                                </div>
                                                <div class="mb-2">
                                ...
                                <br>
                                <!-- jika status MCU bukan 0 -->
                                @if ($schedule->mcu_status != '0')
                                    ...
                                    <div class="modal fade" id="resulttestModal{{ $schedule->id }}" tabindex="-1" aria-labelledby="resulttestModalLabel{{ $schedule->id }}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="resulttestModalLabel{{ $schedule->id }}">MCU Detail</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="mb-2">
                                                    ...
                                                    <div class="mb-2">
                                                        <strong>Approval MCU By:</strong><br>
                            ...
                            <td>
                                <div class="dropdown">
                                    @if ($isAdminHR && $schedule->mcu_status == '0')
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $schedule->id }}">
                                        ...
                                        <li>
                                            <form action="{{ route('mcu_schedule.delete', $schedule->id) }}" method="POST" onsubmit="return confirm('Delete this schedule?')">
                                                @csrf
                                                <button type="submit" class="dropdown-item text-danger">Delete</button>
                                            </form>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#resultModal{{ $schedule->id }}">MCU Result</a>
                                        </li>
                                    </ul>
                                    @endif
                                    @if ($schedule->mcu_status == '1')
                        ...
                        <div class="modal fade" id="editModal{{ $schedule->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $schedule->id }}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('mcu_schedule.update', $schedule->id) }}" method="POST">
                                        @csrf
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="mcu_date{{ $schedule->id }}" class="form-label">Testing Date</label>
                                                <input type="datetime-local" name="mcu_date" id="mcu_date{{ $schedule->id }}" class="form-control" value="{{ date('Y-m-d\TH:i', strtotime($schedule->mcu_date)) }}" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="mcu_notes" id="mcu_notes{{ $schedule->id }}" class="form-control">{{ $schedule->mcu_notes }}</textarea>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                        ...
                        <div class="modal fade" id="resultModal{{ $schedule->id }}" tabindex="-1" aria-labelledby="resultModalLabel{{ $schedule->id }}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('mcu_schedule.update.result', $schedule->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="resultModalLabel{{ $schedule->id }}">Input MCU Result</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="mb-3">
