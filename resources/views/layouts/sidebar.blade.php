    ...
    <div id="sidebar-menu">
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            @if(in_array(auth()->user()->role, ['Super Admin', 'Admin', 'Admin HR','Employee']))
                ...
                @if( (auth()->user()->role == 'Admin HR' && in_array(auth()->user()->hie_level, ['1','2','3','4'])) || (in_array(auth()->user()->role, ['Super Admin', 'Admin', 'Employee']) && in_array(auth()->user()->hie_level, ['2','3'])) )
                    <li>
                    ...
                    <li>
                        <a href="{{ route('mcu_schedule.index') }}" class="{{ request()->is('mcu-schedule*') ? 'bg-light active' : '' }}">
